...
export default function Sports() {
  ...
  useEffect(() => {
    const fetchSportsArticles = async () => {
      ...
      setError(null);
      try {
        const response = await axios.get('/api/categories/sports/articles');
        setArticles(response.data.data || []);
        
        // Fetch related articles for "More from this Category" section
        const relatedResponse = await axios.get('/api/categories/sports/articles');
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <HeaderLink />
       <div className="bg-news-bg bg-cover bg-center h-20" style={{
                  backgroundImage: `linear-gradient(to right, #B22222 20%, rgba(178,34,34,0.2)), url('/bg.jpg' )`
                }}>
