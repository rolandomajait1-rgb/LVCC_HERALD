...
export default function Art() {
  ...
  useEffect(() => {
    const fetchArtArticles = async () => {
      ...
      setError(null);
      try {
        const response = await axios.get('/api/categories/art/articles');
        setArticles(response.data.data || []);
        
        // Fetch related articles for "More from this Category" section
        const relatedResponse = await axios.get('/api/categories/art/articles');
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <HeaderLink />
       ...
       <div className="bg-news-bg bg-cover bg-center h-20" style={{
          backgroundImage: `linear-gradient(to right, #06B6D4 20%, rgba(6,182,212,0.2)), url('/bg.jpg' )`
        }}>
