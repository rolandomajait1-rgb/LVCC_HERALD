    ...
    <div className="flex flex-col min-h-screen">
      ...
      <HeaderLink />
        ...
        <div className="bg-news-bg bg-cover bg-center h-20" style={{
                  backgroundImage: `linear-gradient(to right, #FFA500 20%, rgba(255,165,0,0.2)), url('/bg.jpg' )`
                }}>
                ...
                {articles.slice(1, 3).map(article => (
                  <div key={article.id} className="flex-1">
                    <ArticleCard
                      ...
                      slug={article.slug}`n                      isSmall={true}`n                      onEdit={isAdmin() ? () => handleEdit(article.id) : undefined}
