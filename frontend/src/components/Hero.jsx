  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-7xl px-4 py-10 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-3 sm:space-x-2 px-4">
          <Link
            to="/login"
            className="px-8 md:px-10 py-2 bg-cyan-600 hover:bg-cyan-700 text-white font-medium rounded shadow transition duration-150"
          >
            Log In
          </Link>
          <Link
            to="/register"
            className="px-8 md:px-10 py-2 bg-yellow-600 hover:bg-yellow-700 text-white font-medium rounded shadow transition duration-150"
          >
            Sign Up
          </Link>
        </div>
