      ...
      <div className="w-full max-w-md rounded-lg bg-white p-6 md:p-8 shadow-lg my-8" onClick={(e) => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-6 text-left">
            ...
            <div className="relative">
              <input type={showConfirmPassword ? 'text' : 'password'} id="password_confirmation" name="password_confirmation" value={formData.password_confirmation} onChange={handleChange} required placeholder='Confirm Password' onPaste={(e) => e.preventDefault()} autoComplete="new-password" className="w-full rounded-md border border-gray-300 px-4 py-2 pr-10 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" />
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-600">Already have an account? <button onClick={onSwitchToLogin} className="text-blue-600 hover:text-blue-500">Sign in</button></p>
        </div>
      </div>
    </div>
  );
